...
<body>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                        <img src="{{ asset('andaramedical.png')}}" class="h-8 me-3" alt="FlowBite Logo" />
                        <span class="self-center text-xl font-semibold sm:text-xl whitespace-nowrap">Andara Medical Recruitment</span>
                    </a>
                </div>
                ...
                <div class="flex items-center">
                    <div class="flex items-center ms-3">
                        <div>
                            <button type="button" class="flex text-sm bg-gray-500 rounded-full focus:ring-4 focus:ring-gray-300" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm" id="dropdown-user">
                            ...
                            <ul class="py-1" role="none">
                                <li>
                                    ...
                                    @csrf
                                        <button type="submit" class="w-full px-4 py-2 text-start text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Keluar</>
                                    </form>
                                </li>
                            </ul>
                        </div>
    ...
    <!-- Sidebar -->
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white bg-gray-100 border-gray-200 sm:translate-x-0" aria-label="Sidebar">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Hasil Tes</span>
                    </a>
                </li>
